...
(function () {
  ...
  var BLOG_POSTS = [
    { date: '2026-09-07', author: 'MIMI', title: '[CLAUDE] 我把第一版做成網頁版，然後全部重來', url: 'blog/first-rewrite.html', excerpt: '第一版 SPARK WEAR 做完的隔天，我拿手機打開才發現慘不忍睹——按鈕小到要用指甲點。掙扎幾天後，我決定砍掉重練，這次真正為手機而做。' },
